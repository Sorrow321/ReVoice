...
private:
	struct PlaybackState {
		...
		// Carry buffer at 8kHz mono PCM16 to feed encoders exact frame sizes (Opus/Silk/Speex
		// stability). Sized to hold a few frames at the max 1000 ms frame size (8000 samples/frame).
		short pcm8kCarry[32768];
