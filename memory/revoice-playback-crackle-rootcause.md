...
Separate parked idea (loud passages "break up" = clipping from slammed masters + Opus decode overshoot, NOT the crackle): fix = compress/limit to ~-3 dBFS headroom. Details + ffmpeg commands in repo-root `PLAYBACK_LOUDNESS_IDEA.md`.
